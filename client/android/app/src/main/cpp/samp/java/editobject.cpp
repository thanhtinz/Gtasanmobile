...
Java_com_gta_game_ui_AttachEdit_Exit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_gta_game_ui_AttachEdit_AttachClick(JNIEnv *env, jobject thiz, jint button_type,
                                                  jboolean button_id) {

}
extern "C"
JNIEXPORT void JNICALL
Java_com_gta_game_ui_AttachEdit_Save(JNIEnv *env, jobject thiz) {
